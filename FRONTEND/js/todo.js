  ...
  $.ajax({
    ...
    success: function(data){
      ...
      for( let i = 0; i < data.length; i++) {
        ...
        if(!data[i].completed){
          todo.eq(0).append(`<li><input type="checkbox" name="todo" value="${i}"><span>${data[i].description}</span></li>`)
        }
        else{
          todo.eq(1).append(`<li><input type="checkbox" name="todo" value="${i}"><span>${data[i].description}</span></li>`)
        }
